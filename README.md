...
**v2.0.0 - Миграция на реальную базу данных** (11.08.2025)
- ✅ Полная миграция с мок-сервисов на PostgreSQL
- ✅ 11 автомобилей, 21 маршрут, 11 водителей в БД
- ✅ Автоматическое создание пользователей
- ✅ Готовность к продакшену
- 🗑️ Удалены все мок-сервисы
...
Проект использует PostgreSQL с Prisma ORM. **Все данные теперь хранятся в реальной базе данных** (миграция с мок-сервисов завершена):

- **Users** - Пользователи Telegram (автоматически создаются при первом заказе)
- **Vehicles** - 11 автомобилей всех типов (SEDAN, PREMIUM, MINIVAN, MICROBUS, BUS)
- **Drivers** - 11 водителей с реальными контактами
- **Routes** - 21 маршрут включая все направления и отели
- **Bookings** - Заказы трансфера с полной интеграцией

### 🎯 Типы автомобилей

- **SEDAN** - Электромобиль Hongqi EHS 5 (1500 сум/км)
- **PREMIUM** - Электромобиль Hongqi EHS 9 (3000 сум/км)  
- **MINIVAN** - Kia Carnival (2000 сум/км)
- **MICROBUS** - Mercedes-Benz Sprinter (2500 сум/км)
- **BUS** - Автобус Higer (3000 сум/км)
...
- ✅ Полная система заказов и водителей
