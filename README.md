...
[![Telegram](https://img.shields.io/badge/Telegram-2CA5E0?style=for-the-badge&logo=telegram&logoColor=white)](https://t.me/your_bot)
...
- [🚗 Водительское приложение](DRIVER_APP_FINAL.md)
- [⚙️ Система настроек](SETTINGS_SETUP.md)
- [👥 Управление пользователями](USERS_SETUP.md)
- [🚙 Управление транспортом](VEHICLES_SETUP.md)

### 🎯 Быстрые ссылки:

- **Админ панель:** http://localhost:3003/admin/dashboard
- **Водительское приложение:** http://localhost:3003/driver
- **API документация:** В разделе выше
- **Тестовые страницы:** В разделе тестирования
